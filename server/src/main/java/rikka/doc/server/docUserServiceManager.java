...
import moe.doc.starter.ServiceStarter;
import rikka.hidden.compat.PackageManagerApis;
import rikka.hidden.compat.UserManagerApis;
import rikka.doc.server.util.UserHandleCompat;

public class docUserServiceManager extends UserServiceManager {
    ...
    public String getUserServiceStartCmd(
        ...
        return ServiceStarter.commandForUserService(
                appProcess,
                docService.getManagerApplicationInfo().sourceDir,
