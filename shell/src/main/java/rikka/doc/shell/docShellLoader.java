...
public class docShellLoader {
    ...
    private static void requestForBinder() throws RemoteException {
        ...
        Intent intent = new Intent("rikka.doc.intent.action.REQUEST_BINDER")
                .setPackage("moe.doc.privileged.api")
        ...
        try {
            ...
            Intent activityIntent = Intent.createChooser(
                    new Intent("rikka.doc.intent.action.REQUEST_BINDER")
                            .addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP)
                            .addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                            .addFlags(Intent.FLAG_ACTIVITY_NEW_DOCUMENT)
                            .putExtra("data", data),
                    "Request binder from doc"
            );
    ...
    private static void onBinderReceived(IBinder binder, String sourceDir) {
        ...
        try {
            ...
            Class<?> cls = classLoader.loadClass("moe.doc.manager.shell.Shell");
            ...
            System.err.println("Make sure you have doc v12.0.0 or above installed");
            System.err.flush();
            System.exit(1);
        } catch (Throwable tr) {
    ...
    public static void main(String[] args) {
        ...
        docShellLoader.callingPackage = packageName;
        ...
        handler.postDelayed(() -> abort(
                String.format(
                        "Request timeout. The connection between the current app (%1$s) and doc app may be blocked by your system. " +
                                "Please disable all battery optimization features for both current app (%1$s) and doc app.",
                        packageName)
        ), 5000);
