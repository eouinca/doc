...
import rikka.doc.docBinderWrapper

object docSystemApis {

    init {
        SystemServiceBinder.setOnGetBinderListener {
            return@setOnGetBinderListener docBinderWrapper(it)
        }
    }
