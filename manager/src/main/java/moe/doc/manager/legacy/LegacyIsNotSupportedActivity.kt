...
import moe.doc.manager.MainActivity
...
class LegacyIsNotSupportedActivity : AppActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val v3Support = ai.metaData?.getBoolean("moe.doc.client.V3_SUPPORT") == true
        if (v3Support) {
            MaterialAlertDialogBuilder(this)
                    ...
                    .setNeutralButton(R.string.dialog_requesting_legacy_button_open_doc) { _, _ ->
