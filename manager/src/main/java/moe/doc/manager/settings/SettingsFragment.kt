...
import moe.doc.manager.docSettings.KEEP_START_ON_BOOT
import moe.doc.manager.app.ThemeHelper
import moe.doc.manager.app.ThemeHelper.KEY_BLACK_NIGHT_THEME
import moe.doc.manager.app.ThemeHelper.KEY_USE_SYSTEM_COLOR
import moe.doc.manager.ktx.isComponentEnabled
import moe.doc.manager.ktx.setComponentEnabled
import moe.doc.manager.ktx.toHtml
import moe.doc.manager.receiver.BootCompleteReceiver
import moe.doc.manager.utils.CustomTabsHelper
import rikka.core.util.ResourceUtils
import rikka.material.app.LocaleDelegate
import rikka.recyclerview.addEdgeSpacing
import rikka.recyclerview.fixEdgeEffect
import rikka.doc.manager.docLocales
import rikka.widget.borderview.BorderRecyclerView
import java.util.*
import moe.doc.manager.docSettings.LANGUAGE as KEY_LANGUAGE
import moe.doc.manager.docSettings.NIGHT_MODE as KEY_NIGHT_MODE
...
class SettingsFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        preferenceManager.sharedPreferencesName = docSettings.NAME
        ...
        if (docSettings.getNightMode() != AppCompatDelegate.MODE_NIGHT_NO) {
    ...
    private fun setupLocalePreference() {
        val localeTags = docLocales.LOCALES
        val displayLocaleTags = docLocales.DISPLAY_LOCALES
        ...
        val currentLocale = docSettings.getLocale()
