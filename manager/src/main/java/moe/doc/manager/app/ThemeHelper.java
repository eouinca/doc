...
import moe.doc.manager.utils.EnvironmentUtils;
...
public class ThemeHelper {
    ...
    public static boolean isBlackNightTheme(Context context) {
        return docSettings.getPreferences().getBoolean(KEY_BLACK_NIGHT_THEME, EnvironmentUtils.isWatch(context));
    }

    public static boolean isUsingSystemColor() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.S
                && docSettings.getPreferences().getBoolean(KEY_USE_SYSTEM_COLOR, true);
    }
    ...
    public static String getTheme(Context context) {
        ...
        return docSettings.getPreferences().getString(KEY_LIGHT_THEME, THEME_DEFAULT);
    }
