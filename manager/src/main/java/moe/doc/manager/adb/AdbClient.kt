package moe.doc.manager.adb

import android.util.Log
import moe.doc.manager.adb.AdbProtocol.ADB_AUTH_RSAPUBLICKEY
import moe.doc.manager.adb.AdbProtocol.ADB_AUTH_SIGNATURE
import moe.doc.manager.adb.AdbProtocol.ADB_AUTH_TOKEN
import moe.doc.manager.adb.AdbProtocol.A_AUTH
import moe.doc.manager.adb.AdbProtocol.A_CLSE
import moe.doc.manager.adb.AdbProtocol.A_CNXN
import moe.doc.manager.adb.AdbProtocol.A_MAXDATA
import moe.doc.manager.adb.AdbProtocol.A_OKAY
import moe.doc.manager.adb.AdbProtocol.A_OPEN
import moe.doc.manager.adb.AdbProtocol.A_STLS
import moe.doc.manager.adb.AdbProtocol.A_STLS_VERSION
import moe.doc.manager.adb.AdbProtocol.A_VERSION
import moe.doc.manager.adb.AdbProtocol.A_WRTE
