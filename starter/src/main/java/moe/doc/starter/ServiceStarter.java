...
import moe.doc.starter.util.IContentProviderCompat;
import rikka.hidden.compat.ActivityManagerApis;
import rikka.doc.docApiConstants;
import rikka.doc.server.UserService;

public class ServiceStarter {

    private static final String TAG = "docServiceStarter";

    private static final String EXTRA_BINDER = "moe.doc.privileged.api.intent.extra.BINDER";
    ...
    private static final String USER_SERVICE_CMD_FORMAT = "(CLASSPATH='%s' %s%s /system/bin " +
            "--nice-name='%s' moe.doc.starter.ServiceStarter " +
    ...
    private static IBinder docBinder;
    ...
    private static boolean sendBinder(IBinder binder, String token, boolean retry) {
        String packageName = "moe.doc.privileged.api";
        ...
        try {
            ...
            extra.putString(docApiConstants.USER_SERVICE_ARG_TOKEN, token);
            ...
            if (reply != null) {
                ...
                if (container != null && container.binder != null && container.binder.pingBinder()) {
                    docBinder = container.binder;
                    docBinder.linkToDeath(() -> {
                        Log.i(TAG, "exiting...");
                        System.exit(0);
                    }, 0);
                    return true;
